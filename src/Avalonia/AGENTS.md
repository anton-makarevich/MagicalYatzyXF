...
Before writing or editing any AXAML or Avalonia-specific C# in this folder, load and follow the `avalonia-ui` skill and use the `avalonia-docs` MCP tools it describes.
