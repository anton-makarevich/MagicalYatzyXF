...
public class RollResultViewModel:BindableBase
{
    ...
    public string ShortName => _localizationService.GetString(_rollResult.ScoreType+"Short");
    public string Name => _localizationService.GetString(_rollResult.ScoreType.ToString());
