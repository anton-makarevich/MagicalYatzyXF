...
public class RuleViewModelTests
{
    ...
    public void HasCorrectLocalizedNameReturnedByLocalizationService()
    {
        ...
        _localizationService.GetString(TestRule.ToString()).Returns(expectedName);
        var name = _sut.Name;
    ...
    public void HasCorrectLocalizedDescriptionReturnedByLocalizationService()
    {
        ...
        _localizationService.GetString(TestRule.ToString()+ "Short").Returns(expectedDescription);
