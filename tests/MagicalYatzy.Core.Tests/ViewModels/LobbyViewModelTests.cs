...
public class LobbyViewModelTests
{
    ...
    {
        _localizationService.GetString("PlayersLabel").Returns(Strings.PlayersLabel);
        _localizationService.GetString("RulesLabel").Returns(Strings.RulesLabel);
    ...
    {
        _localizationService.GetString("StartGameButton").Returns(Strings.StartGameButton);
        _localizationService.GetString("AddBotLabel").Returns(Strings.AddBotLabel);
        _localizationService.GetString("AddPlayerLabel").Returns(Strings.AddPlayerLabel);
    ...
    {
        _localizationService.GetString("BotNameDefault").Returns("Bot");
